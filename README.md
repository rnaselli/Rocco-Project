...
-- Need to include link for tableu 
+Rocco
...
There must be an ordered list in your résumé. //number list
There must be an unordered list in your résumé. //bullet points 
https://www.tutorialrepublic.com/html-tutorial/html-lists.php <- Check this part out.
+Rocco
